...
def BotTrading2(pairs, apiKey, secret, password, id, running, maxActivePositions, telegram, chat_id, mode, withMode):
...
if __name__ == '__main__':
    ...
    r = rq.get(url).json()
    BotTrading2(r[0]['pairList'], r[0]['APIkey'], r[0]['APIsecret'], r[0]['APIpassword'], r[0]['id'], r[0]['running'], r[0]['maxActivePositions'], r[0]['telegram'],r[0]['chat_id'], r[0]['mode'], r[0]['withMode'])
