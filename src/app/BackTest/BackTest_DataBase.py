                    ...
                    if positionInProgress[i] != '':
                        if positionInProgress[i]['position'] == 'openLong':
                            ...
                            if actualRow['low'] < positionInProgress[i]['liquidation']:
                                ...
                                myrow = {
                                    'id' : id,
                                    'sortKey': str(symbols[i]+str(index)),
                                    'symbol': symbols[i],
                                    'date': str(index),
                                ...
                                Telegram(chat_id).messageClose('closeLongPosition', str(index), resultat, symbols[i], 'take profit touché', performance, round(usdInvest * performance), actualRow['close'])
                                myrow={} 
                                ...
                                positionInProgress[i] = ''
                                rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                                Telegram(chat_id).messageClose('closeLongPosition', str(index), resultat, symbols[i], 'stop loss touché', performance, round(usdInvest * performance), actualRow['close'])
                                myrow={} 
                                ...
                                positionInProgress[i] = ''
                                rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                                Telegram(chat_id).messageClose('closeLongPosition', str(index), resultat, symbols[i], 'indicateur touché', performance, round(usdInvest * performance), actualRow['close'])
                                myrow={} 
                            ...
                            if actualRow['high'] > positionInProgress[i]['liquidation']:
                                ...
                                positionInProgress[i] = ''
                                rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                                Telegram(chat_id).messageClose('closeShortPosition', str(index), resultat, symbols[i], 'take profit touché', performance, round(usdInvest * performance), actualRow['close'])
                                myrow={} 
                                ...
                                positionInProgress[i] = ''
                                rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                                Telegram(chat_id).messageClose('closeShortPosition', str(index), resultat, symbols[i], 'stop loss touché', performance, round(usdInvest * performance), actualRow['close'])
                                myrow={} 
                                ...
                                positionInProgress[i] = ''
                                rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                                Telegram(chat_id).messageClose('closeShortPosition', str(index), resultat, symbols[i], 'indicateur touché', performance, round(usdInvest * performance), actualRow['close'])
                                myrow={} 
...
###################################  
                    ...
                    if trade.openLongPosition(actualRow, previousRow) and positionInProgress[i] == '' and usdArray[-1]>1:
                        ...
                        activePositions += 1
                        rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                        Telegram(chat_id).messageOpen("openLong", str(index), symbols[i], usdInvest, actualRow['close'], leverage, stopLossValue, takeProfitValue)
                        myrow={} 
                    ...
                    if trade.openShortPosition(actualRow, previousRow) and positionInProgress[i] == '' and usdArray[-1]>1:
                        ...
                        activePositions += 1
                        rq.put(url, json=myrow, headers={'Content-Type': 'application/json'})
                        Telegram(chat_id).messageOpen("openShort", str(index), symbols[i], usdInvest, actualRow['close'], leverage, stopLossValue, takeProfitValue)
                        myrow={} 
...
if __name__ == '__main__':
    ...
    print(backtest.trade(pairList, '1h', start_date='2023-01-01', end_date='2023-03-27', leverage=1.5))
