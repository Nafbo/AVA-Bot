...
class Telegram ():
    ...
    def  messageOpen (self, position, date, crypto, usdInvest, price, leverage, stopLoss, takeProfit):
        if position == 'openLong':
            message = ("Bonjour, 👋\n\n"
                        ...
                        "Cordialement,\n"
                        "Votre AVA Bot de trading. 🤖").format(crypto, date, usdInvest, price, leverage, stopLoss, takeProfit)
    ...
    def messageClose (self, position, date, gain, crypto, close, performance, gainUsd, price):
        if gain == 'good'  :
            if position == 'closeLongPosition' : 
                    message = ("Bonjour, 👋\n\n"
                        ...
                        "Cordialement,\n"
                        "Votre AVA Bot de trading. 🤖").format(crypto, date, close, performance, gainUsd, price)
